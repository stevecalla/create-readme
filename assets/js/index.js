...
nextSteps = () => {
  console.log(`\n------------------`);
  console.log(`The README.md starter is now available in your current directory. This starter includes placeholders for static images or video along with a variety of other placeholders to enhance and customize the README. Please edit as necessary to finalize.`);
  console.log(`------------------\n`)
}
